...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  await user.save({ setValidatators: false });
  ...
  try {
    ...
    return next(new AppErr('There was an error sending the email', 500));
  }
});
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  if (!(await user.correctPassword(req.body.passwordCurr, user.password))) {
